        ...
        <div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center"} -->
            <div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"style":{"spacing":{"padding":{"top":"2.5rem","right":"2.5rem","bottom":"2.5rem","left":"2.5rem"}},"border":{"radius":"10px","width":"2px"}},"borderColor":"light-gray","layout":{"type":"constrained"}} -->
                <div class="wp-block-group has-border-color has-light-gray-border-color" style="border-width:2px;border-radius:10px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"fontSize":"large"} -->
                    <h2 class="wp-block-heading has-text-align-center has-large-font-size" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px"><?php _e('Basic', 'jadro'); ?></h2>
                    <!-- /wp:heading -->
                    ...
                    <div class="wp-block-group"><!-- wp:paragraph {"fontSize":"max-60"} -->
                        <p class="has-max-60-font-size"><?php _e('$49', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->

                        <!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"1.5rem"}}}} -->
                        <p style="margin-top:1.5rem">/<?php _e('year', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                    ...
                    <div class="wp-block-group"><!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Responsive Layouts', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <p class="has-text-align-center"><?php _e('Full Site Editing', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Block Pattern Library', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Support via Public Forum', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                    ...
                    <div class="wp-block-buttons" style="margin-top:3.5rem"><!-- wp:button {"width":100} -->
                        <div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" href="#"><?php _e('Get Started', 'jadro'); ?></a></div>
                        <!-- /wp:button -->
                    </div>
                    <!-- /wp:buttons -->
                </div>
            ...
            <div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"style":{"spacing":{"padding":{"top":"2.5rem","right":"2.5rem","bottom":"2.5rem","left":"2.5rem"}},"border":{"radius":"10px","width":"2px"}},"borderColor":"light-gray","backgroundColor":"light-gray","layout":{"type":"constrained"}} -->
                <div class="wp-block-group has-border-color has-light-gray-border-color has-light-gray-background-color has-background" style="border-width:2px;border-radius:10px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"fontSize":"large"} -->
                    <h2 class="wp-block-heading has-text-align-center has-large-font-size" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px"><?php _e('Advanced', 'jadro'); ?></h2>
                    <!-- /wp:heading -->

                    <!-- wp:group {"style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center","justifyContent":"center"}} -->
                    <div class="wp-block-group"><!-- wp:paragraph {"fontSize":"max-60"} -->
                        <p class="has-max-60-font-size"><?php _e('$99', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                    ...
                    <!-- wp:group {"layout":{"type":"constrained"}} -->
                    <div class="wp-block-group"><!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Everything in Basic', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('One Click Demo Import', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Additional Block Patterns', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Support via Dedicated Email', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
            ...
            <div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"style":{"spacing":{"padding":{"top":"2.5rem","right":"2.5rem","bottom":"2.5rem","left":"2.5rem"}},"border":{"radius":"10px","width":"2px"}},"borderColor":"light-gray","layout":{"type":"constrained"}} -->
                <div class="wp-block-group has-border-color has-light-gray-border-color" style="border-width:2px;border-radius:10px;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"fontSize":"large"} -->
                    <h2 class="wp-block-heading has-text-align-center has-large-font-size" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px"><?php _e('Premium', 'jadro'); ?></h2>
                    <!-- /wp:heading -->

                    <!-- wp:group {"style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center","justifyContent":"center"}} -->
                    <div class="wp-block-group"><!-- wp:paragraph {"fontSize":"max-60"} -->
                        <p class="has-max-60-font-size"><?php _e('$499', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                    ...
                    <!-- wp:group {"layout":{"type":"constrained"}} -->
                    <div class="wp-block-group"><!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Everything in Advanced', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Monthly Maintenance Service', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Website Security Hardening', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- wp:paragraph {"align":"center"} -->
                        <p class="has-text-align-center"><?php _e('Onpage SEO Included', 'jadro'); ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
