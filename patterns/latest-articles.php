...
<h2 class="wp-block-heading has-text-align-center has-max-60-font-size" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px"><?php esc_html_e( 'Latest Articles', 'jadro' ); ?></h2>
<!-- /wp:heading -->
