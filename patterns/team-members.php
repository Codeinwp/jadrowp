...
<p class="has-text-align-left has-text-color has-medium-font-size" style="color:#e06035;font-style:normal;font-weight:600"><?php esc_html_e( 'Experienced and Creative', 'jadro' ); ?></p>
<!-- /wp:paragraph -->
...
<p style="margin-bottom:0.75rem"><?php esc_html_e( 'An experienced team working together, crafting exceptional experiences, and growing stronger.', 'jadro' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
