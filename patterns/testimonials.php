...
<figure class="wp-block-image size-full has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/headshot-square-1.jpg' ) ); ?>" alt="" class="wp-image-305" style="border-radius:100%"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/headshot-square-2.jpg' ) ); ?>" alt="" class="wp-image-302" style="border-radius:100%"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/headshot-square-3.jpg' ) ); ?>" alt="" class="wp-image-303" style="border-radius:100%"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
