...
<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"},"color":{"text":"#e06035"}},"className":"has-text-align-left","fontSize":"medium"} -->
<p class="has-text-align-left has-text-color has-medium-font-size" style="color:#e06035;font-style:normal;font-weight:600"><?php esc_html_e( 'Customer Reviews', 'jadro' ); ?></p>
<!-- /wp:paragraph -->
...
<p style="margin-bottom:0.75rem"><?php esc_html_e( 'A range of testimonials from our happy customers across a variety of industries and use cases.', 'jadro' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<div class="wp-block-group alignwide" style="padding-top:2rem"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"backgroundColor":"white"} -->
<div class="wp-block-column has-white-background-color has-background"><!-- wp:group {"style":{"spacing":{"padding":{"top":"2.5rem","right":"2.5rem","bottom":"2.5rem","left":"2.5rem"}},"border":{"color":"#e7e7e7","width":"1px","radius":"10px"},"dimensions":{"minHeight":"100%"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-border-color" style="border-color:#e7e7e7;border-width:1px;border-radius:10px;min-height:100%;padding-top:2.5rem;padding-right:2.5rem;padding-bottom:2.5rem;padding-left:2.5rem"><!-- wp:columns {"verticalAlignment":"center","isStackedOnMobile":false,"align":"wide","style":{"spacing":{"margin":{"right":"0px","left":"0px"},"blockGap":{"top":"20px","left":"20px"}}}} -->
